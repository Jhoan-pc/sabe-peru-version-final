// ==========================================
// CARTA MAESTRA FINAL - SABE A PERÚ
// FECHA DE BLOQUEO: 17 DE FEBRERO 2026
// ==========================================
// ESTE ARCHIVO ES LA ÚNICA FUENTE DE VERDAD.
// CONTIENE:
// 1. TODA LA COMIDA (Entradas, Platos, Postres, Hamburguesas, Ensaladas)
// 2. TODAS LAS BEBIDAS (Refrescos, Cervezas, Vinos, Batidos, Sangría)
// 3. TODOS LOS CÓCTELES (Clásicos y de Autor)
//
// EJECUTAR ESTE SCRIPT RESTAURA LA BASE DE DATOS AL ESTADO PERFECTO.
// NO EDITAR BAJO NINGUNA CIRCUNSTANCIA SIN AUTORIZACIÓN EXPRESA.
// ==========================================
...
const menuItems = [
    ...
    // BATIDOS DE FRUTA (Category: bebida, Sub: BEBIDAS Y BATIDOS)
    ...
    // --- CÓCTELES (Category: coctel, Sub: COCTELERÍA) ---
...
async function seed() {
    console.log('--- APLICANDO CARTA MAESTRA DEFINITIVA ---')
    console.log('1. Eliminando todo el menú anterior...')
    await supabase.from('menu_items').delete().neq('id', '00000000-0000-0000-0000-000000000000')

    console.log('2. Insertando carta completa (Comida, Bebidas, Cócteles)...')
    const { error } = await supabase.from('menu_items').insert(menuItems)

    if (error) {
        console.error('ERROR CRÍTICO AL INSERTAR:', error)
    } else {
        console.log('✅ ¡CARTA MAESTRA APLICADA CORRECTAMENTE!')
        console.log(`✅ Total ítems insertados: ${menuItems.length}`)
    }
}
